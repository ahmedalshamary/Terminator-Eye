...
while True:
        ...
        for face in res['faces']:
            ...
            cv2.putText(frame, "Person {:.1f}".format(counter),
                (13+(count * 30),frame.shape[0] - 94), cv2.FONT_HERSHEY_SIMPLEX, .75, (255, 255, 255), 2)
            cv2.putText(frame, "Age = {:.1f}".format(age - 2),
                (13+(count * 30),frame.shape[0] - 69), cv2.FONT_HERSHEY_SIMPLEX, .75, (255, 255, 255), 2)
            cv2.putText(frame, "Gender = {}".format(gender),
                (13+ (count * 30),frame.shape[0] - 44), cv2.FONT_HERSHEY_SIMPLEX, .75, (255, 255, 255), 2)
            count = count + 100
            counter = counter + 1
